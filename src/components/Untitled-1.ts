...
//   // Update localStorage whenever activeItems changes
//   useEffect(() => {
...
//         const alrdyCheckedTask =completedTasks.find(item => item.id ==checkedTask.id)
//     //     console.log(checkedTask)
//       // const completedTasks =localStorage.getItem("completedTasks")?JSON.parse(localStorage.getItem("completedTasks")):[]
//       if(!alrdyCheckedTask){
//       completedTasks.push(checkedTask);
//       console.log(!alrdyCheckedTask);
...
//       setActiveItems((prev) =>
//       prev.includes(idd) ? prev.filter((item) => item !== idd) : [...prev, idd]
//     );
...
//     const activeTasks=()=>{
//       const tasksList = localStorage.getItem("tasks")? JSON.parse(localStorage.getItem("tasks")) :[]
//       const activeTsk =tasksList.filter((item) => item.id == completedTasks.id)
//       console.log(completedTasks);
//       console.log(activeTsk);
...
//                           <FaCheck id={'checkIcon'+item.id} className={activeItems.includes(`${item.id}`) ? "show" : "hide"}/>
//                         </div>
//                       </div>
//                         <label htmlFor=""><input type="checkbox" data-task={item.task} data-id={item.id} name="" id="" className='taskCheck' /> {item.task}</label>
//                         <span id={item.id} className='hide'>✔️</span>
